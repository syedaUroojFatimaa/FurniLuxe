...
<hr className="border-t border-gray-300 my-1 ml-6 mr-6" />
      ...
      <div className="max-w-6xl mx-auto p-6">
        <h1 className="text-3xl font-bold mb-6 text-center">All Furniture Products</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {products.map((product) => (
            <div key={product.id} className="border rounded-lg shadow-md bg-white relative min-h-[350px]">
<Image src={product.image} alt={product.name} width={300} height={224} className="w-full h-56 object-cover rounded-t-lg" />
